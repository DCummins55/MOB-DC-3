...
func multipletimes(numberofKnocks: Int) {
    
    for i in 1...numberofKnocks {
        println(i)
    }
...
func whoisthere(name: String, country: String) {
    println("its me \(name), from \(country)" )
    
}

whoisthere("Devin", "USA")
...
let mycalculateAge = calculateAge(1987)
println("...and my age is \(mycalculateAge)")
...
func tellname(nameandage: String, yearofbirth: Int) {
    let age = calculateAge(<#yearOfBirth: Int#>)
    println("\")
}
